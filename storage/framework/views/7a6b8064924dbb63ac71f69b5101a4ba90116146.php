...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light m-2">
        <div class="container">
            <a href="#" class="navbar-brand mb-0 h1">
                <!-- <img class="d-inline-block align-top" src="<?php echo e(url('/imagecss/img4.jpg')); ?>" width="50" height="50"/>
                Navbar  -->
                <div id="logo">
            <img src="<?php echo e(url('/imagecss/img4.jpg')); ?>" alt="Logo de Zozor" />
            <h2>  </h2>
        </div>
            </a> 
    ...
    <img  class="img-2" src="<?php echo e(url('/imagecss/ecole1.png')); ?>"/>
    </div>  
</div>
    <!-- <div class="container">
    ...
    <!-- <div class="container">
            <img class="img1" src="<?php echo e(url('/imagecss/img1.jpg')); ?>" alt="...">
    </div> -->
       
</body>
</html><?php /**PATH C:\xampp\htdocs\projet\gestion_sortie\resources\views/home.blade.php ENDPATH**/ ?>