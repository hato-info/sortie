...
<body>
    <nav class="navbar navbar-expand-sm navbar-light bg-light m-2">
        <div class="container">
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="d-inline-block align-top" src="<?php echo e(url('/imagecss/img4.jpg')); ?>" width="40" height="40"/>
    ...
    <img  class="img-2" src="<?php echo e(url('/imagecss/img1.jpg')); ?>"/>
    </div>
    <main class="py-4">
...
</html><?php /**PATH C:\xampp\htdocs\projet\gestion_sortie\resources\views/app.blade.php ENDPATH**/ ?>