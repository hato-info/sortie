 ...
 <script type="text/javascript">
  ...
  function onScanSuccess(data) { 
    $.ajax({
      type: "POST",
      cache: false,
      url : "<?php echo e(action('App\Http\Controllers\ListeCodeController@checkUser')); ?>",
      ...
      success: function(response) {
        ...
        if (response){
            ...
            $(location).attr('href', '<?php echo e(url('/index')); ?>');
            }
       else{ //alert(data);
       // $(location).attr('href', '<?php echo e(url('/index')); ?>');
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\Laravel9\gestion_sortie\resources\views/eleve/qrscan.blade.php ENDPATH**/ ?>